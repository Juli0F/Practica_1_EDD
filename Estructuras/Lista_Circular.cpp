    ...
    if (primero != nullptr){
        ...
        while (temp != nullptr){
            if (temp == ultimo){
                ...
                string strFinal = "\t\t\"cliente: " + id_cliente1_str + " comprando\" -> \"cliente: " + id_cliente2_str + " comprando\";\n";
                string strFinal_retroceso = "\t\t\"cliente: " + id_cliente2_str + " comprando\" -> \"cliente: " + id_cliente1_str + " comprando\";\n";
